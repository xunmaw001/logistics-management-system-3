<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="重量计费" prop="zhongliangjifei">
          <el-input v-model="ruleForm.zhongliangjifei" 
              placeholder="重量计费" clearable  :readonly="ro.zhongliangjifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="重量计费" prop="zhongliangjifei">
              <el-input v-model="ruleForm.zhongliangjifei" 
                placeholder="重量计费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物流费" prop="wuliufei">
            <el-input v-model="wuliufei"
                placeholder="物流费" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wuliufei" label="物流费" prop="wuliufei">
              <el-input v-model="ruleForm.wuliufei" 
                placeholder="物流费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    wuliufei:{
      get: function () {
        return 1*this.ruleForm.zhongliangjifei*this.ruleForm.zhongliang
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wupinleixing = true;
          ...
          if(o=='zhongliangjifei'){
            this.ruleForm.zhongliangjifei = obj[o];
	    this.ro.zhongliangjifei = true;
            continue;
          }
          if(o=='zhongliang'){
	    ...
	    this.ro.zhongliang = true;
          ...
          if(o=='wuliufei'){
            this.ruleForm.wuliufei = obj[o];
	    this.ro.wuliufei = true;
            continue;
          }
          if(o=='shangmendizhi'){
      ...
      this.$http({
		...
		if(json.jijianrenxingming!=''&&json.jijianrenxingming){
              		this.ruleForm.jijianrenxingming = json.jijianrenxingming
		}
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.dingdanzhuangtaiOptions = "已接收,未接收".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.wuliufei = this.wuliufei
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
