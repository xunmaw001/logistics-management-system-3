<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="物流编号" prop="wuliubianhao">
            <el-input v-model="ruleForm.wuliubianhao" 
                placeholder="物流编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wuliubianhao" label="物流编号" prop="wuliubianhao">
              <el-input v-model="ruleForm.wuliubianhao" 
                placeholder="物流编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="寄件人姓名" prop="jijianrenxingming">
          <el-input v-model="ruleForm.jijianrenxingming" 
              placeholder="寄件人姓名" clearable  :readonly="ro.jijianrenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="寄件人姓名" prop="jijianrenxingming">
              <el-input v-model="ruleForm.jijianrenxingming" 
                placeholder="寄件人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收件人姓名" prop="shoujianrenxingming">
          <el-input v-model="ruleForm.shoujianrenxingming" 
              placeholder="收件人姓名" clearable  :readonly="ro.shoujianrenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收件人姓名" prop="shoujianrenxingming">
              <el-input v-model="ruleForm.shoujianrenxingming" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="配送员工号" prop="peisongyuangonghao">
          <el-select  @change="peisongyuangonghaoChange" v-model="ruleForm.peisongyuangonghao" placeholder="请选择配送员工号">
            <el-option
                v-for="(item,index) in peisongyuangonghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.peisongyuangonghao" label="配送员工号" prop="peisongyuangonghao">
              <el-input v-model="ruleForm.peisongyuangonghao" 
                placeholder="配送员工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物流状态" prop="wuliuzhuangtai">
          <el-select v-model="ruleForm.wuliuzhuangtai" placeholder="请选择物流状态">
            <el-option
...
export default {
  data() {
	...
	lianxifangshi : false,
	tupian : false,
	peisongyuangonghao : false,
	peisongyuanxingming : false,
	lianxidianhua : false,
	wuliuzhuangtai : false,
      },
      ruleForm: {
        wuliubianhao: this.getUUID(),
        yonghuming: '',
        jijianrenxingming: '',
        shouji: '',
        wupinmingcheng: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='wuliubianhao'){
            this.ruleForm.wuliubianhao = obj[o];
	    this.ro.wuliubianhao = true;
            continue;
          }
          if(o=='yonghuming'){
	    ...
	    this.ro.yonghuming = true;
          ...
          if(o=='jijianrenxingming'){
            this.ruleForm.jijianrenxingming = obj[o];
	    this.ro.jijianrenxingming = true;
            continue;
          }
          if(o=='shouji'){
	    ...
	    this.ro.mudedi = true;
          ...
          if(o=='shoujianrenxingming'){
            this.ruleForm.shoujianrenxingming = obj[o];
	    this.ro.shoujianrenxingming = true;
            continue;
          }
          if(o=='lianxifangshi'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='peisongyuangonghao'){
            this.ruleForm.peisongyuangonghao = obj[o];
	    this.ro.peisongyuangonghao = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/peisongyuan/peisongyuangonghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.peisongyuangonghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            this.wuliuzhuangtaiOptions = "等待配送,配送中,已签收".split(',')
    },
    // 下二随
    peisongyuangonghaoChange () {
      this.$http({
        url: `follow/peisongyuan/peisongyuangonghao?columnValue=`+ this.ruleForm.peisongyuangonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.peisongyuanxingming){
                this.ruleForm.peisongyuanxingming = data.data.peisongyuanxingming
              }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wuliuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wuliuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
