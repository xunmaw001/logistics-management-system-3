<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剩余距离" prop="shengyujuli">
          <el-input v-model="ruleForm.shengyujuli" 
              placeholder="剩余距离" clearable  :readonly="ro.shengyujuli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剩余距离" prop="shengyujuli">
              <el-input v-model="ruleForm.shengyujuli" 
                placeholder="剩余距离" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chufashijian = true;
          ...
          if(o=='shengyujuli'){
            this.ruleForm.shengyujuli = obj[o];
	    this.ro.shengyujuli = true;
            continue;
          }
        }
      }
